    ...
    <div className="min-h-screen bg-gradient-hero flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center px-4">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Join thousands saving up to 50% on premium subscriptions
        </p>
      </div>
        ...
        <div className="bg-card/30 backdrop-blur-xl border border-border/10 shadow-elegant rounded-2xl p-6 sm:p-8">
          ...
          {success && (
            <div className="mb-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm rounded-xl p-3 flex items-start gap-2.5 animate-in fade-in slide-in-from-top-1">
              ...
              <div>
                ...
                <p className="mt-2 text-xs opacity-75">Redirecting to login page in 5s...</p>
              </div>
            </div>
          )}
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="firstName" className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">
                  First Name *
                </label>
                <input
                  id="firstName"
              ...
              <div>
                <label htmlFor="lastName" className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">
                  Last Name *
                </label>
                <input
                  id="lastName"
          ...
          <div className="mt-6 pt-6 border-t border-border/10 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/login" className="text-brand hover:text-gold transition-colors font-medium">
                Log in
              </Link>
            </p>
          </div>
