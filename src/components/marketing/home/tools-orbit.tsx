  ...
  return (
    <div className="relative mx-auto aspect-square w-full max-w-[390px] overflow-visible sm:max-w-[560px] lg:max-w-[640px]">
      ...
      <div className="absolute left-1/2 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2">
        <div className="relative grid h-28 w-28 place-items-center rounded-full bg-card shadow-elegant ring-1 ring-border sm:h-40 sm:w-40">
          <div className="relative flex flex-col items-center justify-center text-center">
            <div className="font-display text-3xl font-extrabold text-gradient sm:text-4xl">80+</div>
            ...
            <div className="mx-auto mt-1.5 h-[2px] w-8 rounded-full bg-gold" />
          </div>
        </div>
      </div>
            ...
            >
              <div className="flex flex-col items-center gap-1.5">
                <div
                  ...
                  title={t.name}
                >
                  <div className="absolute inset-0 rounded-full bg-gradient-brand opacity-0 transition group-hover:opacity-[0.06]" />
